...
public class DuplicateLead {
	...
	public static void main(String[] args) {
		...
		elementCompanyName.sendKeys("IVTL Infoview");
		...
		//Click on Create Lead button by using name
		...
		WebElement elementDupicate=  driver.findElement(By.className("subMenuButton"));
	    elementDupicate.click();
